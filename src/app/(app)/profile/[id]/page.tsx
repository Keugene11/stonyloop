    ...
    <div className="max-w-5xl mx-auto px-4 pt-12 pb-28 animate-slide-up">
      ...
      <div className="flex flex-col md:flex-row md:gap-6 md:items-start">
        ...
        <div className={`md:w-[340px] md:flex-shrink-0 md:sticky md:top-4 ${activeTab === 'info' ? 'block' : 'hidden'} md:block`}>
          ...
          {/* Contact */}
            <div className="bg-bg-card border border-border rounded-2xl px-4 py-3 mb-3 space-y-0.5">
              {profile.email && <div className="flex items-center gap-2 text-[13px] py-0.5"><Mail size={13} className="text-text-muted flex-shrink-0" /><span className="text-accent break-all">{profile.email}</span></div>}
